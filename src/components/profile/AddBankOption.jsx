...
const AddBankOption = ({ onPress }) => {
  return (
    <TouchableOpacity 
      ...
      className="mb-8"
    >
      <GlassView className="p-5 rounded-[24px] border border-blue-500/20 bg-blue-500/5">
        <View className="flex-row items-center">
          ...
          <View className="flex-1">
            ...
            <Text className="text-blue-400/60 text-xs">Send and receive money with UPI</Text>
          </View>
